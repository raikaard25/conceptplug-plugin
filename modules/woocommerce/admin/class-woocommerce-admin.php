		...
		wp_localize_script(
			...
			array(
				...
				'i18n'           => array(
					...
					'enhanceImageQueued'     => __( 'Waiting for image design to start…', 'conceptplug' ),
					'enhanceImageGenerating' => __( 'Generating product image — this can take a few minutes…', 'conceptplug' ),
					'enhanceImageSaving'     => __( 'Saving the designed image to your site…', 'conceptplug' ),
					'enhanceImageMissing'    => __( 'Image design finished but the result could not be loaded. Try again or check that your site can download from ConceptPlug cloud storage.', 'conceptplug' ),
